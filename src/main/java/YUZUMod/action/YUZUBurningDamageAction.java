...
public class YUZUBurningDamageAction extends AbstractGameAction {
    private static final float DURATION = 0.3F;

    public YUZUBurningDamageAction(AbstractCreature target, AbstractCreature source, int amount, AttackEffect effect) {
