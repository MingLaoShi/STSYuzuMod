...
import YUZUMod.power.YUZUFlameModulePower;
...
public class YUZUFlameModule extends YUZUCustomCard{
    ...
    public void commonUse(AbstractPlayer abstractPlayer, AbstractMonster abstractMonster) {
        addToBot(new ApplyPowerAction(abstractPlayer,abstractPlayer,new YUZUFlameModulePower(abstractPlayer,this.magicNumber)));
