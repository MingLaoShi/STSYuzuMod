...
import YUZUMod.cards.YUZUSolidifying;
import YUZUMod.power.YUZUMagazineFillingPower;
...
public class DiscardAtEndOfTurnActionPatch {
    ...
    public static class updatePatch {
        ...
        public static void updatePatch(DiscardAtEndOfTurnAction __instance) {
            ...
            if (AbstractDungeon.player.hasPower(YUZUMagazineFillingPower.POWER_ID)) {
                AbstractDungeon.player.getPower(YUZUMagazineFillingPower.POWER_ID).onSpecificTrigger();
            }
        }
    }
}
