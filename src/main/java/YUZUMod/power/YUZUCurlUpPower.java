...
public class YUZUCurlUpPower extends AbstractPower {
    ...
    private static final String IMG_84=ModHelper.makeImgPath("power","CurlUpPower84");
    private static final String IMG_32=ModHelper.makeImgPath("power","CurlUpPower32");
