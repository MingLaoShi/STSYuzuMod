...
import YUZUMod.action.YUZUBurningDamageAction;
...
public class YUZUBurningPower extends AbstractPower {
    ...
    private static final String IMG_84=ModHelper.makeImgPath("power","BurningPower84");
    private static final String IMG_32=ModHelper.makeImgPath("power","BurningPower32");
    private int damage;
