...
public class YUZUPaintingsPower extends AbstractPower {
    ...
    private static final String IMG_84=ModHelper.makeImgPath("power","PaintingsPower84");
    private static final String IMG_32=ModHelper.makeImgPath("power","PaintingsPower32");
